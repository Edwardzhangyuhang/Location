...
public class UARTLoopbackActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if(act_string != null && -1 != act_string.indexOf("android.intent.action.MAIN")){
			restorePreference();
		}			
		else if(act_string != null && -1 != act_string.indexOf("android.hardware.usb.action.USB_ACCESSORY_ATTACHED")){
			cleanPreference();
		}		
